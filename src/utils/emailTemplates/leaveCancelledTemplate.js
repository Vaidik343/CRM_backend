...
module.exports = function leaveCancelledTemplate({
  employee,
  leave,
  leaveDays,
}) {
  ...
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #ffffff; border-radius: 8px; border: 1px solid #e5e7eb; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
      ...
      <div style="height: 4px; background-color: #d97706; border-radius: 4px 4px 0 0; margin: -24px -24px 20px -24px;"></div>

      <!-- Header -->
      <div style="margin-bottom: 16px;">
        <h2 style="margin: 0; color: #d97706; font-size: 20px; font-weight: 600;">Leave Request Cancelled</h2>
      </div>

      <p style="color: #374151; font-size: 14px; margin-top: 0; margin-bottom: 20px; line-height: 1.5;">
        Hello,<br>
        <b>${employee.name}</b> has cancelled a previously submitted leave request.
      </p>
      ...
      <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 14px;">
        <tbody>
          ...
          <tr>
            <td style="padding: 10px 0; color: #6b7280; font-weight: 500;">Cancelled On</td>
            <td style="padding: 10px 0; color: #111827;">${formatDate(new Date())}</td>
          </tr>
        </tbody>
      </table>
      ...
      <div style="margin-top: 24px; padding-top: 16px; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 13px; line-height: 1.5;">
        <p style="margin: 0 0 12px 0;">This leave request has been withdrawn by the employee and requires no further action.</p>
        <p style="margin: 0;">
          Regards,<br>
