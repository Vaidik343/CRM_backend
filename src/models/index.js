...
// ── EmployeeApplication → EmployeeApplicationDocument ──
EmployeeApplication.hasMany(EmployeeApplicationDocument, {
  foreignKey: 'application_id',
  as: 'documents',
});

EmployeeApplicationDocument.belongsTo(EmployeeApplication, {
  foreignKey: 'application_id',
  as: 'application',
});
