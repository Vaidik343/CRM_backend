...
const { createTask, listTasks, getTask, updateTask, getTaskStatusLogs, deleteTask, createTaskValidators, updateTaskValidators , getRemarkSummary} = require("../controllers/tasks.controller");

const router = express.Router();

router.get   ("/tasks",authenticate,listTasks);
router.get("/tasks/remark-summary", authenticate, requireAdmin, getRemarkSummary);
